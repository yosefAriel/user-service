    ...
    stage('clone kd-helm reposetory and update the tag '){
      ...
      steps {
        ...
        script {
           ...
           sh "sed -e '29 i ${env.space2}imagePullSecrets:' ./common/templates/_deployment.yaml > changed.yaml && mv changed.yaml ./common/templates/_deployment.yaml"
          //  sh "sed '30 ${env.space1} name: acr-secret' ./common/templates/_deployment.yaml"
           sh "sed -e '30 i ${env.space1}'-' name: acr-secret' ./common/templates/_deployment.yaml > changed.yaml && mv changed.yaml ./common/templates/_deployment.yaml"
