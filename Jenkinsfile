    ...
    stage('clone kd-helm reposetory and update the tag '){
      ...
      steps {
        ...
        script {
           ...
           sh "sed -i '29 ${env.space2} i imagePullSecrets:' ./common/templates/_deployment.yaml"
          //  sh "sed '30 ${env.space1} name: acr-secret' ./common/templates/_deployment.yaml"
           sh "sed -i '30 i ${env.space1} i '-' name: acr-secret' ./common/templates/_deployment.yaml"
